...
return (
  <div className="fixed inset-0 flex justify-center">
    ...
    <div className="relative h-4/5 bg-white mt-10 sm:p-6 md:p-8 lg:p-5 w-72 lg:w-full xl:w-2/5 rounded-md z-10">
          ...
          <form className="max-w-lg mx-auto" onSubmit={handleSubmit}>
            ...
            <div className="mb-2">
              ...
              <input
                ...
                className="border rounded-xl w-full mt-1 sm:p-1" // Responsive width
                required
              />
            </div>
            {/* ... other form inputs ... */}
            ...
            <div className="mb-2">
              ...
              <input
                ...
                onChange={handleChange}
                className="border rounded-xl w-full mt-1 sm:p-1 "
                required
              />
            </div>
            {/* ... other form inputs ... */}
            ...
            <button
              type="submit"
              className="bg-blue-500 w-full text-white px-4 rounded-xl mt-1 sm:p-1  hover:bg-blue-600"
            >
              Submit Application
            </button>
           ...
           <button
              className="bg-blue-500 w-full text-white px-4 mt-2 sm:p-1 rounded-xl hover:bg-blue-600"
              onClick={onClose}
            >
              Close
            </button>
