...
import JobsCard from './Graduatesjobs';
  ...
  return (
    <div>
      ...
      <main className="container py-8">
        <h1 className="text-3xl font-bold mb-4" style={{ color: 'black' }} data-aos="fade-right">Welcome to Haidri Beverages - Our Culture</h1>
        ...
        <h2 className="text-2xl font-bold mb-2" style={{ color: 'black' }} data-aos="fade-up">Our Values in Action</h2>
        <section className="mb-8" data-aos="fade-up">
          <p style={{ color: 'black' }}>
        ...
        <section className="mb-8" data-aos="fade-up">
          <h2 className="text-2xl font-bold mb-2" style={{ color: 'black' }}>Community Engagement</h2>
          <p style={{ color: 'black' }}>
